...
//    [_headerView addSubview:_buttonPresent];
    ...
    //  头像
    self.headImage = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth / 2 - 40, 160, 80, 80)];
    ...
    //  用户名
    self.labelName = [[UILabel alloc] initWithFrame:CGRectMake(0, 260, ScreenWidth, 21)];
